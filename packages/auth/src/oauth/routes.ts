// packages/auth/src/oauth/routes.ts
/**
 * OAuth Routes
 *
 ...
 */
export const oauthRouteEntries: Array<[string, BaseRouteDefinition]> = [
  // Initiate OAuth flow
  [
    'auth/oauth/google',
    publicRoute<undefined, { url: string } | { message: string }>(
      'GET',
      async (
        ctx: HandlerContext,
        _body: undefined,
  ...
  [
    ...
    protectedRoute<undefined, { url: string } | { message: string }>(
      'POST',
      async (
        ctx: HandlerContext,
        _body: undefined,
