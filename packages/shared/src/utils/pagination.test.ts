// shared/src/utils/pagination.test.ts
...
describe('pagination utilities', () => {
  ...
  describe('paginatedResultSchema', () => {
    const schema = paginatedResultSchema(z.object({ id: z.string(), name: z.string() }));
  ...
  describe('cursorPaginatedResultSchema', () => {
    const schema = cursorPaginatedResultSchema(z.object({ id: z.string() }));
