...
describe('guard', () => {
  ...
  describe('assert', () => {
    ...
    it('throws custom error from factory when condition is false', () => {
      ...
      expect(() => assert(false, 'type error', factory)).toThrow(TypeError);
      expect(() => assert(false, 'type error', factory)).toThrow('type error');
    });
  ...
  describe('assertDefined', () => {
    ...
    it('throws custom error from factory', () => {
      ...
      expect(() => assertDefined(null, 'range', factory)).toThrow(RangeError);
    });
  });
