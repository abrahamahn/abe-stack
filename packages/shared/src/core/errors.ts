...
import { ERROR_CODES, HTTP_STATUS, type ErrorCode } from './constants';
...
export class NotFoundError extends AppError {
  constructor(message = 'Not found', code: ErrorCode = ERROR_CODES.RESOURCE_NOT_FOUND) {
...
export class TooManyRequestsError extends AppError {
  constructor(message = 'Too many requests', code: ErrorCode = ERROR_CODES.RATE_LIMITED) {
...
export class OAuthError extends AppError {
  constructor(
    ...
    code: ErrorCode = ERROR_CODES.OAUTH_ERROR,
  ) {
 ...
 */
export function formatValidationErrors(issues: import('zod').ZodIssue[]): ValidationErrorResponse {
