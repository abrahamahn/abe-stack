// packages/realtime/src/websocket/lifecycle.test.ts
/**
...
// Mock the CSRF validation from http package
vi.mock('@abe-stack/http', async (importOriginal) => {
...
import type { RealtimeModuleDeps } from '../types';

// ============================================================================
// Test Helpers
// ============================================================================

function createMockCtx(overrides: Partial<RealtimeModuleDeps> = {}): RealtimeModuleDeps {
  return {
    db: {} as never,
    pubsub: {
      handleMessage: vi.fn(),
