// packages/sdk/src/query/QueryCacheProvider.test.tsx
  ...
  describe('integration with QueryCache features', () => {
    it('should support stale time configuration', () => {
      const StaleTimeConsumer = (): ReactNode => {
        ...
        return <span data-testid="is-stale">{isStale === true ? 'true' : 'false'}</span>;
      };
    ...
    it('should support query removal', () => {
      const RemovalConsumer = (): ReactNode => {
        ...
        return (
          <div>
            <span data-testid="before-removal">{beforeRemoval === true ? 'true' : 'false'}</span>
            <span data-testid="after-removal">{afterRemoval === true ? 'true' : 'false'}</span>
          </div>
        );
      };
