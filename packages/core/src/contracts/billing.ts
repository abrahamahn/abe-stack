// packages/core/src/contracts/billing.ts
/**
 * Billing Contract
 *
...
export const syncStripeResponseSchema: Schema<SyncStripeResponse> = createSchema((data: unknown) => {
  if (!data || typeof data !== 'object') {
  ...
  if (typeof obj.stripeProductId !== 'string') throw new Error('stripeProductId must be a string');
  return {
    success: obj.success,
    stripePriceId: obj.stripePriceId,
    stripeProductId: obj.stripeProductId,
