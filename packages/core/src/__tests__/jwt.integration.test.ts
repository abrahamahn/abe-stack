// packages/core/src/__tests__/integration/jwt.integration.test.ts
/**
...
import { decode, JwtError, sign, verify } from '../infrastructure/crypto/jwt';
...
describe('JWT Integration', () => {
  ...
  describe('Real-world authentication scenarios', () => {
    ...
    it('should handle logout and token invalidation', () => {
      // Note: Token invalidation typically requires server-side storage
