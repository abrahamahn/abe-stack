// packages/core/src/__tests__/integration/pagination.integration.test.ts
/**
...
import { createCursorForItem, decodeCursor, encodeCursor } from '../../domains/pagination/cursor';
import { PaginationError } from '../../domains/pagination/error';
import {
  buildCursorPaginationQuery,
  calculateCursorPaginationMetadata,
  paginateArrayWithCursor,
  paginateLargeArrayWithCursor,
} from '../../domains/pagination/helpers';
