// packages/db/src/scripts/db-push.ts
 ...
 * Ordered by dependency: tables first (respecting foreign keys), then indexes.
 */
 ...
 *
 * Executes all CREATE TABLE and CREATE INDEX statements sequentially.
 * Safe to run multiple times (uses IF NOT EXISTS).
 *
 * @throws {Error} When a SQL statement fails to execute.
 */
 ...
 *
 * Useful for testing or inspection without executing.
 *
