// packages/db/src/schema/magic-link.test.ts
/**
...
import { MAGIC_LINK_TOKEN_COLUMNS, MAGIC_LINK_TOKENS_TABLE } from './magic-link.js';

import type { MagicLinkToken, NewMagicLinkToken } from './magic-link.js';
