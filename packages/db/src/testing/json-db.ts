// packages/db/src/testing/json-db.ts
/**
...
// =============================================================================
// Configuration Type (locally defined to avoid @abe-stack/core dependency)
// =============================================================================

/**
 * JSON file-based database configuration.
 * Compatible with the interface defined in @abe-stack/core.
 */
