// infra/jobs/src/write/write-service.test.ts
/**
...
import type { SubscriptionManager } from '@abe-stack/shared/pubsub';
...
describe('WriteService', () => {
  ...
  describe('hooks', () => {
    it('should execute beforeValidate hooks', async () => {
      const beforeValidateHook = vi.fn(async (op: WriteOperation) => ({
        ...op,
