// packages/security/src/permissions/types.ts
/**
 * Permissions Types
 *
 ...
 *
 * @param id - Record ID
 * @param ownerId - Owner user ID (for ownership-based permissions)
 * @param createdBy - Created by user ID (alternative to ownerId)
 * @param workspaceId - Workspace ID (for workspace-based permissions)
 * @param teamId - Team ID (for team-based permissions)
 * @param memberIds - Member IDs array (for shared records)
 * @param sharedWith - Shared with user IDs (alternative to memberIds)
 * @param deleted - Whether the record is deleted (soft delete)
 */
 ...
 * @param permission - Permission type being requested
 * @param operation - Operation being performed (for write permissions)
 */
 ...
 * @param matchedRule - Permission rule that matched (for debugging)
 */
 ...
 * @param tables - Tables this rule applies to (empty = all tables)
 * @param grants - Permissions this rule grants
 ...
 *
 * @param ownerField - Field name that contains the owner ID (default: 'ownerId' or 'createdBy')
 */
 ...
 *
 * @param memberField - Field name that contains member IDs (default: 'memberIds' or 'sharedWith')
 */
 ...
 *
 * @param roles - Roles that are granted these permissions
 */
 ...
 *
 * @param table - Table name
 * @param rules - Rules for this table
 * @param allowDeletedRecords - Whether soft-deleted records should be visible
 */
 ...
 *
 * @param globalRules - Global rules (apply to all tables unless overridden)
 * @param tableConfigs - Table-specific configurations
 * @param defaultDeny - Default behavior when no rules match
 */
