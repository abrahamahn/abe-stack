// packages/security/src/permissions/checker.ts
/**
 * Permission Checker
 *
 ...
 * @param recordLoader - Function to load individual records
 * @param batchRecordLoader - Optional batch record loader for efficiency
 */
 ...
 *
 * @returns A default PermissionConfig with admin, ownership, and membership rules
 */
