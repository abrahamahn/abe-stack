// packages/ui/src/primitives/__tests__/Accordion.test.tsx
...
describe('Accordion', () => {
  ...
  describe('edge cases - cleanup', () => {
    it('cleans up properly on unmount', () => {
      ...
      expect(document.querySelector('.ui-accordion')).not.toBeInTheDocument();
    });
  });
  ...
  describe('accessibility', () => {
    ...
    it('uses semantic HTML structure', () => {
      ...
      headings.forEach((heading) => {
        expect(heading).toHaveClass('ui-accordion-heading');
