// packages/ui/src/layouts/__tests__/Container.test.tsx
...
describe('Container', () => {
  it('renders with default size and className', () => {
    ...
    expect(container).toHaveClass('ui-container');
    expect(container).toHaveClass('ui-container--md');
  });

  it('supports size variants', () => {
    const { rerender } = render(<Container size="sm">Small</Container>);
    expect(screen.getByText('Small')).toHaveClass('ui-container--sm');

    rerender(<Container size="lg">Large</Container>);
    expect(screen.getByText('Large')).toHaveClass('ui-container--lg');
  });
