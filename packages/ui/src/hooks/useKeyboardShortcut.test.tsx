// packages/ui/src/hooks/__tests__/useKeyboardShortcut.test.tsx
...
describe('useKeyboardShortcut', () => {
  describe('basic functionality', () => {
    it('triggers handler when key is pressed', () => {
      const handler = vi.fn();
      render(<ShortcutHarness shortcutKey="z" handler={handler} />);
    ...
    it('is case-insensitive for key matching', () => {
      const handler = vi.fn();
      render(<ShortcutHarness shortcutKey="a" handler={handler} />);
    ...
    it('handles special keys like Escape', () => {
      const handler = vi.fn();
      render(<ShortcutHarness shortcutKey="Escape" handler={handler} />);
    ...
    it('passes the event to the handler', () => {
      const handler = vi.fn();
      render(<ShortcutHarness shortcutKey="s" handler={handler} />);
  ...
  describe('modifier keys', () => {
    it('requires ctrl when ctrl option is true', () => {
      const handler = vi.fn();
      render(<ShortcutHarness shortcutKey="z" ctrl handler={handler} />);
    ...
    it('requires shift when shift option is true', () => {
      const handler = vi.fn();
      render(<ShortcutHarness shortcutKey="z" shift handler={handler} />);
    ...
    it('requires alt when alt option is true', () => {
      const handler = vi.fn();
      render(<ShortcutHarness shortcutKey="z" alt handler={handler} />);
    ...
    it('requires meta when meta option is true', () => {
      const handler = vi.fn();
      render(<ShortcutHarness shortcutKey="z" meta handler={handler} />);
    ...
    it('supports multiple modifiers', () => {
      const handler = vi.fn();
      render(<ShortcutHarness shortcutKey="z" ctrl shift handler={handler} />);
  ...
  describe('enabled option', () => {
    it('does not trigger when disabled', () => {
      const handler = vi.fn();
      render(<ShortcutHarness shortcutKey="z" handler={handler} enabled={false} />);
    ...
    it('triggers when enabled', () => {
      const handler = vi.fn();
      render(<ShortcutHarness shortcutKey="z" handler={handler} enabled={true} />);
  ...
  describe('skipInputs option', () => {
    ...
    it('skips text inputs when skipInputs is true', () => {
      const handler = vi.fn();
      render(<ShortcutHarness shortcutKey="z" handler={handler} skipInputs />);
  ...
  describe('preventDefault option', () => {
    ...
    it('does not prevent default when preventDefault is false', () => {
      const handler = vi.fn();
      render(<ShortcutHarness shortcutKey="z" handler={handler} preventDefault={false} />);
  ...
  describe('stopPropagation option', () => {
    ...
    it('stops propagation when stopPropagation is true', () => {
      const handler = vi.fn();
      render(<ShortcutHarness shortcutKey="z" handler={handler} stopPropagation />);
  ...
  describe('cleanup', () => {
    it('removes event listener on unmount', () => {
      const handler = vi.fn();
      const { unmount } = render(<ShortcutHarness shortcutKey="z" handler={handler} />);
    ...
    it('removes event listener when disabled', () => {
      ...
      const { rerender } = render(
        <ShortcutHarness shortcutKey="z" handler={handler} enabled={true} />,
      );

      fireEvent.keyDown(window, { key: 'z' });
      expect(handler).toHaveBeenCalledTimes(1);

      rerender(<ShortcutHarness shortcutKey="z" handler={handler} enabled={false} />);
      fireEvent.keyDown(window, { key: 'z' });
  ...
  describe('keyup event', () => {
    it('supports keyup event type', () => {
      const handler = vi.fn();
      render(<ShortcutHarness shortcutKey="z" handler={handler} eventType="keyup" />);
