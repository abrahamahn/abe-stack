// packages/ui/src/router/components.test.tsx
/**
...
describe('Link', () => {
  ...
  describe('modified clicks', () => {
    ...
    it('should allow default behavior for shift+click', async () => {
      ...
      await user.click(link, { shiftKey: true });
    ...
    it('should allow default behavior for alt+click', async () => {
      ...
      await user.click(link, { altKey: true });
  ...
  describe('edge cases', () => {
    ...
    it('should handle special characters in to prop', () => {
      ...
      expect(screen.getByRole('link', { name: 'Link' })).toHaveAttribute('href', '/path/with spaces');
    });
    ...
    it('should handle to prop with query string', () => {
      ...
      expect(screen.getByRole('link', { name: 'Search' })).toHaveAttribute('href', '/search?q=test');
    });
...
describe('Navigate', () => {
  ...
  describe('conditional navigation', () => {
    it('should navigate when condition changes', async () => {
      const ConditionalNavigate = ({ shouldNavigate }: { shouldNavigate: boolean }): ReactElement => {
        return (
          <MemoryRouter initialEntries={['/']}>
            <Routes>
              <Route
