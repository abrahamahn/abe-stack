// packages/ui/src/components/DelayedFallback.test.tsx
/**
...
describe('DelayedFallback', () => {
  ...
  describe('Suspense integration', () => {
    it('should work as Suspense fallback', () => {
      const LazyComponent = (): React.JSX.Element => <div>Loaded!</div>;

      render(
        <React.Suspense fallback={<DelayedFallback delay={10} />}>
          <LazyComponent />
        </React.Suspense>,
      );
