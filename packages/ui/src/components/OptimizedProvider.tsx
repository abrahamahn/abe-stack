// packages/ui/src/components/OptimizedProvider.tsx
/**
 ...
 */
export function useRenderPerformance(componentName: string): RenderPerformanceResult {
  ...
  React.useEffect(() => {
    ...
    if (isDev) {
      ...
      console.log(
        `[Render] ${componentName} rendered (${String(renderCountRef.current)} times, ${String(renderTime)}ms)`,
      );
    }
  });
