...
```tsx
import { ResizablePanelGroup, ResizablePanel, ResizableSeparator } from 'abeahn-ui/primitives';
```
...
const [leftSize, setLeftSize] = useState(() => {
  return Number(localStorage.getItem('leftPanelSize')) || 30;
});
...
- [Source](../../src/primitives/ResizablePanel.tsx)
- [Tests](../../src/primitives/__tests__/ResizablePanel.test.tsx)
