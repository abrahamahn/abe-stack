...
**Source:** `packages/auth/src/utils/password.ts`, `packages/auth/src/config/auth.ts`
...
**Source:** `packages/auth/src/utils/password.ts:115-202`
...
**Source:** `packages/core/src/infrastructure/crypto/jwt.ts`, `packages/auth/src/utils/jwt.ts`
...
**Source:** `packages/auth/src/utils/refresh-token.ts`, `packages/auth/src/utils/jwt.ts`
...
**Source:** `packages/auth/src/utils/refresh-token.ts:109-241`
...
**Source:** `packages/auth/src/security/lockout.ts`, `packages/auth/src/security/types.ts`, `packages/auth/src/types.ts`
...
**Source:** `packages/auth/src/security/rateLimitPresets.ts`, `packages/auth/src/config/auth.ts`
...
**Source:** `packages/http/src/middleware/csrf.ts`
...
**Source:** `packages/http/src/middleware/security.ts`
...
**Source:** `packages/http/src/middleware/validation.ts`
...
**Source:** `packages/auth/src/config/auth.ts`, `packages/auth/src/utils/cookies.ts`, `packages/http/src/middleware/cookie.ts`
...
**Source:** `packages/auth/src/service.ts`, `packages/auth/src/utils/password.ts`
...
**Source:** `packages/core/src/modules/auth/password-scoring.ts`
...
**Source:** `packages/security/src/crypto/jwt-rotation.ts`
...
**Source:** `packages/auth/src/security/events.ts`, `packages/auth/src/security/audit.ts`
...
**Source:** `packages/media/src/security.ts`
...
**Source:** `packages/auth/src/config/auth.ts:240-278`, `packages/core/src/config/env.schema.ts`
...
**Source:** `packages/http/src/plugins.ts`
