...
**Source:** `backend/core/src/auth/utils/password.ts`, `backend/core/src/auth/config/auth.ts`
...
**Source:** `backend/core/src/auth/utils/password.ts:115-202`
...
**Source:** `packages/shared/src/core/jwt.ts`, `backend/core/src/auth/utils/jwt.ts`
...
**Source:** `backend/core/src/auth/utils/refresh-token.ts`, `backend/core/src/auth/utils/jwt.ts`
...
**Source:** `backend/core/src/auth/utils/refresh-token.ts:109-241`
...
**Source:** `backend/core/src/auth/security/lockout.ts`, `backend/core/src/auth/security/types.ts`, `backend/core/src/auth/types.ts`
...
**Source:** `backend/core/src/auth/security/rateLimitPresets.ts`, `backend/core/src/auth/config/auth.ts`
...
**Source:** `backend/core/src/auth/config/auth.ts`, `backend/core/src/auth/utils/cookies.ts`, `infra/src/http/middleware/cookie.ts`
...
**Source:** `backend/core/src/auth/service.ts`, `backend/core/src/auth/utils/password.ts`
...
**Source:** `packages/shared/src/domain/auth/auth.password-scoring.ts`
...
**Source:** `backend/core/src/auth/security/events.ts`, `backend/core/src/auth/security/audit.ts`
...
**Source:** `backend/core/src/auth/config/auth.ts:240-278`, `packages/shared/src/core/env.ts`
