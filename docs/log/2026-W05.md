...
**Barrel cleanup**: Removed re-exports from `@abe-stack/shared` in `apps/server/main/shared/index.ts`. Updated ~25 consumer files to import errors directly. Golden standard: barrels export only local items.
