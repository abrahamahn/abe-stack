...
- Created `AuthFormLayout` compound component in `@abe-stack/ui` (`main/client/ui/src/components/AuthForm.tsx`) wrapping `.auth-form-*` CSS classes with sub-components: Content, Header, Title, Subtitle, Fields, Error, Footer, Divider
