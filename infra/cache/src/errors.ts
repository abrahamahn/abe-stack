...
import { AppError, HTTP_STATUS } from '@abe-stack/core';
 ...
 * @returns True if the error is a CacheError instance
 */
 ...
 *
 * @param error - The value to check
 * @returns True if the error is a CacheConnectionError instance
 */
 ...
 *
 * @param error - The value to check
 * @returns True if the error is a CacheTimeoutError instance
 */
