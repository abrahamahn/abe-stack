...
export const billingRoutes = createRouteMap([
  // Plans (public)
  [
    'billing/plans',
    publicRoute<undefined, PlansListResponse | { message: string }>(
      'GET',
  ...
  [
    ...
    protectedRoute<undefined, SubscriptionResponse | { message: string }>(
      'GET',
      async (
        ctx: AppContext,
        _body: undefined,
  ...
  [
    'billing/checkout',
    protectedRoute<CheckoutRequest, CheckoutResponse | { message: string }>(
      'POST',
      async (
        ctx: AppContext,
  ...
  [
    ...
    protectedRoute<CancelSubscriptionRequest, SubscriptionActionResponse | { message: string }>(
      'POST',
      async (
        ctx: AppContext,
  ...
  [
    ...
    protectedRoute<EmptyBillingBody, SubscriptionActionResponse | { message: string }>(
      'POST',
      async (
        ctx: AppContext,
  ...
  [
    ...
    protectedRoute<UpdateSubscriptionRequest, SubscriptionActionResponse | { message: string }>(
      'POST',
      async (
        ctx: AppContext,
  ...
  [
    'billing/invoices',
    protectedRoute<undefined, InvoicesListResponse | { message: string }>(
      'GET',
      async (
        ctx: AppContext,
        _body: undefined,
  ...
  [
    ...
    protectedRoute<undefined, PaymentMethodsListResponse | { message: string }>(
      'GET',
      async (
        ctx: AppContext,
        _body: undefined,
  ...
  [
    ...
    protectedRoute<AddPaymentMethodRequest, PaymentMethodResponse | { message: string }>(
      'POST',
      async (
        ctx: AppContext,
  ...
  [
    ...
    protectedRoute<EmptyBillingBody, SetupIntentResponse | { message: string }>(
      'POST',
      async (
        ctx: AppContext,
        _body: EmptyBillingBody,
