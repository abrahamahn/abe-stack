// modules/auth/src/login-edge-cases.test.ts
// modules/auth/src/__tests__/login-edge-cases.test.ts
/**
...
import { AccountLockedError, InvalidCredentialsError } from '@abe-stack/shared';
...
import type { AuthConfig } from '@abe-stack/shared';
