// apps/server/src/modules/auth/__tests__/routes.test.ts
/**
...
describe('Auth Routes', () => {
  ...
  describe('auth/register Route', () => {
    const registerRoute = authRoutes['auth/register']!;
    ...
    test('should be a public route (no auth required)', () => {
      expect(registerRoute.auth).toBeUndefined();
    });
    ...
    describe('Handler Invocation', () => {
      ...
      test('should call handleRegister with correct arguments', async () => {
        const { handleRegister } = await import('../handlers.js');
  ...
  describe('auth/login Route', () => {
    const loginRoute = authRoutes['auth/login']!;
    ...
    test('should be a public route (no auth required)', () => {
      expect(loginRoute.auth).toBeUndefined();
    });
    ...
    describe('Handler Invocation', () => {
      ...
      test('should call handleLogin with correct arguments', async () => {
        const { handleLogin } = await import('../handlers.js');
  ...
  describe('auth/refresh Route', () => {
    const refreshRoute = authRoutes['auth/refresh']!;
    ...
    test('should be a public route (no auth required)', () => {
      expect(refreshRoute.auth).toBeUndefined();
    });
    ...
    describe('Handler Invocation', () => {
      ...
      test('should call handleRefresh with correct arguments', async () => {
        const { handleRefresh } = await import('../handlers.js');
  ...
  describe('auth/logout Route', () => {
    const logoutRoute = authRoutes['auth/logout']!;
    ...
    test('should be a public route (no auth required)', () => {
      expect(logoutRoute.auth).toBeUndefined();
    });
    ...
    describe('Handler Invocation', () => {
      ...
      test('should call handleLogout with correct arguments', async () => {
        const { handleLogout } = await import('../handlers.js');
  ...
  describe('auth/logout-all Route', () => {
    const logoutAllRoute = authRoutes['auth/logout-all']!;
    ...
    test('should require user authentication', () => {
      expect(logoutAllRoute.auth).toBe('user');
    });
    ...
    describe('Handler Invocation', () => {
      ...
      test('should call handleLogoutAll with correct arguments', async () => {
        const { handleLogoutAll } = await import('../handlers.js');
  ...
  describe('auth/forgot-password Route', () => {
    const forgotPasswordRoute = authRoutes['auth/forgot-password']!;
    ...
    test('should be a public route (no auth required)', () => {
      expect(forgotPasswordRoute.auth).toBeUndefined();
    });
    ...
    describe('Handler Invocation', () => {
      ...
      test('should call handleForgotPassword with correct arguments', async () => {
        const { handleForgotPassword } = await import('../handlers.js');
  ...
  describe('auth/reset-password Route', () => {
    const resetPasswordRoute = authRoutes['auth/reset-password']!;
    ...
    test('should be a public route (no auth required)', () => {
      expect(resetPasswordRoute.auth).toBeUndefined();
    });
    ...
    describe('Handler Invocation', () => {
      ...
      test('should call handleResetPassword with correct arguments', async () => {
        const { handleResetPassword } = await import('../handlers.js');
  ...
  describe('auth/verify-email Route', () => {
    const verifyEmailRoute = authRoutes['auth/verify-email']!;
    ...
    test('should be a public route (no auth required)', () => {
      expect(verifyEmailRoute.auth).toBeUndefined();
    });
    ...
    describe('Handler Invocation', () => {
      ...
      test('should call handleVerifyEmail with correct arguments', async () => {
        const { handleVerifyEmail } = await import('../handlers.js');
  ...
  describe('auth/resend-verification Route', () => {
    const resendVerificationRoute = authRoutes['auth/resend-verification']!;
    ...
    test('should be a public route (no auth required)', () => {
      expect(resendVerificationRoute.auth).toBeUndefined();
    });
    ...
    describe('Handler Invocation', () => {
      ...
      test('should call handleResendVerification with correct arguments', async () => {
        const { handleResendVerification } = await import('../handlers.js');
...
describe('Schema Validation', () => {
  ...
  describe('resetPasswordRequestSchema', () => {
    ...
    test('should accept reset password with empty token (validation at handler level)', () => {
      // Note: Schema allows empty token, handler validates token validity
      const request = {
        token: '',
        password: 'NewSecurePassword123!',
      };
...
describe('Route Protection', () => {
  ...
  test('should not have any admin-only routes', () => {
    const adminOnlyRoutes = Object.entries(authRoutes).filter(
