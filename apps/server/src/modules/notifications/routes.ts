...
export const notificationRoutes = createRouteMap([
  ...
  [
    ...
    publicRoute<undefined, VapidKeyResponse | { message: string }>(
      'GET',
  ...
  [
    ...
    protectedRoute<SubscribeRequest, SubscribeResponse | { message: string }>(
      'POST',
      async (
        ctx: AppContext,
  ...
  [
    ...
    protectedRoute<UnsubscribeRequest, UnsubscribeResponse | { message: string }>(
      'POST',
      async (
        ctx: AppContext,
  ...
  [
    ...
    protectedRoute<undefined, PreferencesResponse | { message: string }>(
      'GET',
      async (
        ctx: AppContext,
        _body: undefined,
  ...
  [
    ...
    protectedRoute<UpdatePreferencesRequest, PreferencesResponse | { message: string }>(
      'PUT',
      (
        ctx: AppContext,
  ...
  [
    'notifications/test',
    protectedRoute<undefined, SendNotificationResponse | { message: string }>(
      'POST',
      (
        ctx: AppContext,
        _body: undefined,
  ...
  [
    'notifications/send',
    protectedRoute<SendNotificationRequest, SendNotificationResponse | { message: string }>(
      'POST',
      (
        ctx: AppContext,
