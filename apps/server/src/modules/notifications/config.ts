// modules/notifications/src/config.ts
import type {
  CourierConfig,
  FcmConfig,
  FullEnv,
...
/**
 * Resolves which notification provider to use based on explicit choice and credential availability.
 *
...
/**
 * Throws if notification configuration has validation errors.
 *
 * @param config - Notification configuration to validate
