// apps/server/src/infrastructure/notifications/notification-factory.test.ts
/**
...
describe('createNotificationServiceFromEnv', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  describe('with valid environment variables', () => {
    it('should create service from process.env', () => {
      ...
      const service = createNotificationServiceFromEnv(env);
  ...
  describe('integration behavior', () => {
    it('should create same service as createNotificationService with matching config', () => {
      const credentials = 'test-credentials';
      const projectId = 'test-project';

      const directService = createNotificationService({
        fcm: { credentials, projectId },
      });

      const envService = createNotificationServiceFromEnv({
        FCM_CREDENTIALS: credentials,
