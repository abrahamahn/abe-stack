// apps/server/src/infrastructure/http/middleware/proxyValidation.ts
/**
 ...
 * const untrusted = getValidatedClientIp(
 *   '8.8.8.8',      // X-Forwarded-For (spoofed)
 *   '1.2.3.4',      // Socket IP (not in trusted list)
 *   config
 * );
 * // untrusted.clientIp = '1.2.3.4' (ignores X-Forwarded-For)
 * ```
 */
