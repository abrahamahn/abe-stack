// apps/server/src/infrastructure/search/elasticsearch-provider.test.ts
/**
...
/**
 * Create a mock Elasticsearch config
 */
function createMockConfig(overrides: Partial<ElasticsearchProviderConfig> = {}): ElasticsearchProviderConfig {
  return {
