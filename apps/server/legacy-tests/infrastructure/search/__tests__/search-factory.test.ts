...
const table: Partial<SqlTable> & { table: string } = {
  table: 'users',
  primaryKey: 'id',
  columns: [
...
describe('SearchProviderFactory', () => {
  ...
  describe('createSqlProvider', () => {
    test('should create and register SQL provider', () => {
      ...
      const provider = factory.createSqlProvider(mockDb, mockRepos, table, {
        name: 'test-sql',
      });
  ...
  describe('getProvider', () => {
    test('should return registered provider', () => {
      ...
      factory.createSqlProvider(mockDb, mockRepos, table, { name: 'sql-test' });
  ...
  describe('hasProvider', () => {
    test('should return true for existing provider', () => {
      ...
      factory.createSqlProvider(mockDb, mockRepos, table, { name: 'my-provider' });
  ...
  describe('removeProvider', () => {
    test('should remove existing provider', () => {
      ...
      factory.createSqlProvider(mockDb, mockRepos, table, { name: 'to-remove' });
  ...
  describe('getProviders', () => {
    test('should return all providers as a Map', () => {
      ...
      factory.createSqlProvider(mockDb, mockRepos, table, { name: 'provider1' });
  ...
  describe('getProvidersByType', () => {
    test('should return provider names by type', () => {
      ...
      factory.createSqlProvider(mockDb, mockRepos, table, { name: 'users-sql' });
      factory.createSqlProvider(mockDb, mockRepos, table, { name: 'orders-sql' });
      factory.createElasticsearchProvider({
        name: 'search-es',
        node: 'http://localhost:9200',
        index: 'test',
  ...
  describe('closeAll', () => {
    test('should close all providers and clear the map', async () => {
      ...
      factory.createSqlProvider(mockDb, mockRepos, table, { name: 'p1' });
      factory.createElasticsearchProvider({
        name: 'p2',
        node: 'http://localhost:9200',
        index: 'test',
...
describe('getSearchProviderFactory', () => {
  ...
  test('should persist providers across calls', () => {
    const factory1 = getSearchProviderFactory();
    factory1.createSqlProvider(mockDb, mockRepos, table, { name: 'singleton-test' });
...
describe('resetSearchProviderFactory', () => {
  test('should create new instance after reset', () => {
    const factory1 = getSearchProviderFactory();
    factory1.createSqlProvider(mockDb, mockRepos, table, { name: 'will-be-gone' });
