...
import type { Permission, PermissionRecord, RecordLoader } from '../types';
...
describe('PermissionChecker', () => {
  describe('checkReadPermission', () => {
    test('should allow admin to read any record', async () => {
      ...
      const checker = createTestChecker(createDefaultPermission(), records);
    ...
    test('should deny access to non-existent records', async () => {
      const checker = createTestChecker(createDefaultPermission());
