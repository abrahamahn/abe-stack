  ...
  return (
    <>
      <div style={styles.gallery}>
        {items.map((item) => (
          <div key={item.id} style={styles.item} onClick={() => setSelectedItem(item)}>
            <img src={item.thumbnail || item.src} alt={item.title || ''} style={styles.thumbnail} />
        ...
        <div style={styles.modal} onClick={() => setSelectedItem(null)}>
          <div style={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            {selectedItem.type === 'image' ? (
              <img src={selectedItem.src} alt={selectedItem.title || ''} style={styles.media} />
