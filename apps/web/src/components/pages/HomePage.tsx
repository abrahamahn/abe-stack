  ...
  return (
    ...
    >
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        >
          <h2 style={{ margin: '0 0 10px 0', fontSize: '1.4rem' }}>Built on Chet Stack</h2>
          <p
            style={{
              margin: '0 0 10px 0',
              fontSize: '1.1rem',
        ...
        <section style={{ marginBottom: '40px' }}>
          ...
          >
            <strong>ABE Stack</strong> (Authentication, Backend, and Everything) is a comprehensive
            boilerplate designed to accelerate web application development. It extends the powerful
            foundation of Chet Stack with additional features, UI components, and ready-to-use
            patterns.
          </p>
          <p
            style={{
          ...
          >
            Whether you&apos;re building a social platform, content management system, or any modern
            web application, ABE Stack provides the essential building blocks so you can focus on
            your unique business logic rather than reinventing the wheel.
          </p>
        </section>
        ...
        <section style={{ marginBottom: '40px' }}>
          ...
          >
            While Chet Stack provides an excellent foundation, ABE Stack extends it with additional
        ...
        <section style={{ marginBottom: '40px' }}>
          ...
          >
            The best way to understand ABE Stack is to explore its features. Use the navigation menu
            to check out different sections:
          </p>
          <div
            style={{
              display: 'grid',
        ...
        >
          ...
          <p>
            We are grateful for the excellent foundation provided by Chet Stack, which made this
            extended boilerplate possible.
          </p>
        </footer>
      </div>
    </PageContent>
