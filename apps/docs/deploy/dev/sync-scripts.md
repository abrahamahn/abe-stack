...
Four TypeScript sync scripts automate repetitive development tasks. All scripts are located in `tools/sync/`:
...
Located in `shared/ui/src/theme/`:
...
`shared/ui/src/styles/theme.css` — CSS custom properties:
