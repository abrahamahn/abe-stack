...
**@abe-stack/client (formerly @abeahn/api-client) v1.1.0:**

- Secondary export paths for granular imports:
  - `@abe-stack/client/types` - Import only TypeScript types
  - `@abe-stack/client/client` - Import only the API client factory
  - `@abe-stack/client/react-query` - Import only React Query integration
...
### @abe-stack/client (formerly @abeahn/api-client)
...
- Secondary export paths for granular imports:
  - `@abe-stack/client/types` - TypeScript types only
  - `@abe-stack/client/client` - API client factory only
  - `@abe-stack/client/react-query` - React Query integration only
