...
```typescript
import { initEnv, loadServerEnv } from '@abe-stack/core/config';
...
```typescript
import type { AuthConfig } from '@abe-stack/core/config';
...
pnpm test shared/core/src/config
...
- **Deployment Guide:** [apps/docs/deploy/env.md](../../../../apps/docs/deploy/env.md) - Production deployment configuration
