// shared/ui/src/layouts/shells/index.ts
...
export type { BottombarLayoutProps } from './BottombarLayout';
export type { LeftSidebarLayoutProps } from './LeftSidebarLayout';
export type { RightSidebarLayoutProps } from './RightSidebarLayout';
