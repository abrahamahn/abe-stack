...
describe('useKeyboardShortcut', () => {
  ...
  describe('modifier keys', () => {
    it('requires ctrl when ctrl option is true', () => {
      const handler = vi.fn();
      render(
        createElement(ShortcutHarness, { shortcutKey: 'z', ctrl: true, handler: handler }),
      );
    ...
    it('requires shift when shift option is true', () => {
      const handler = vi.fn();
      render(
        createElement(ShortcutHarness, { shortcutKey: 'z', shift: true, handler: handler }),
      );
      fireEvent.keyDown(window, { key: 'z' });
      expect(handler).not.toHaveBeenCalled();
    ...
    it('requires alt when alt option is true', () => {
      const handler = vi.fn();
      render(
        createElement(ShortcutHarness, { shortcutKey: 'z', alt: true, handler: handler }),
      );
      fireEvent.keyDown(window, { key: 'z' });
      expect(handler).not.toHaveBeenCalled();
    ...
    it('requires meta when meta option is true', () => {
      const handler = vi.fn();
      render(
        createElement(ShortcutHarness, { shortcutKey: 'z', meta: true, handler: handler }),
      );
      fireEvent.keyDown(window, { key: 'z' });
      expect(handler).not.toHaveBeenCalled();
