...
describe('Notification Errors', () => {
  describe('SubscriptionNotFoundError', () => {
    it('should create error with default message', () => {
      const error = new SubscriptionNotFoundError() as Error & { code: string; statusCode: number };
    ...
    it('should create error with identifier', () => {
      const error = new SubscriptionNotFoundError('sub-123') as Error;
  ...
  describe('SubscriptionExistsError', () => {
    it('should create error with default message', () => {
      const error = new SubscriptionExistsError() as Error & { code: string; statusCode: number };
    ...
    it('should create error with custom message', () => {
      const error = new SubscriptionExistsError('Custom message') as Error & {
        code: string;
        statusCode: number;
      };
  ...
  describe('InvalidSubscriptionError', () => {
    it('should create error with default message', () => {
      const error = new InvalidSubscriptionError() as Error & { code: string; statusCode: number };
    ...
    it('should include details', () => {
      const error = new InvalidSubscriptionError('Missing keys', {
        field: 'keys',
      }) as InvalidSubscriptionError & { details: unknown };
  ...
  describe('SubscriptionExpiredError', () => {
    it('should create error with default message', () => {
      const error = new SubscriptionExpiredError() as Error & { code: string; statusCode: number };
    ...
    it('should create error with subscription ID', () => {
      const error = new SubscriptionExpiredError('sub-123') as Error & {
        code: string;
        statusCode: number;
      };
      expect(error.message).toContain('sub-123');
  ...
  describe('NotificationSendError', () => {
    it('should create error with default message', () => {
      const error = new NotificationSendError() as Error & { code: string; statusCode: number };
    ...
    it('should include subscription ID and status code', () => {
      const error = new NotificationSendError(
        ...
        'sub-123',
        410,
      ) as NotificationSendError & { details: unknown };
  ...
  describe('PayloadTooLargeError', () => {
    it('should create error with size info', () => {
      const error = new PayloadTooLargeError(5000, 4096) as Error & {
        message: string;
        code: string;
        actualSize: number;
        maxSize: number;
  ...
  describe('NotificationRateLimitError', () => {
    it('should create error with default message', () => {
      const error = new NotificationRateLimitError() as Error & {
        code: string;
        statusCode: number;
      };
    ...
    it('should include retry after', () => {
      const error = new NotificationRateLimitError(
        'Rate limited',
        60,
      ) as NotificationRateLimitError & { details: unknown };
  ...
  describe('ProviderNotConfiguredError', () => {
    it('should create error with provider name', () => {
      const error = new ProviderNotConfiguredError('web-push') as Error & {
        code: string;
        statusCode: number;
      };
  ...
  describe('ProviderError', () => {
    it('should create error with provider name', () => {
      const error = new ProviderError('Connection failed', 'fcm') as Error & {
        message: string;
        code: string;
        providerName: string;
      };
    ...
    it('should include original error', () => {
      const original = new Error('Network error') as Error & { code: string; statusCode: number };
      const error = new ProviderError('Connection failed', 'fcm', original) as ProviderError & {
  ...
  describe('VapidNotConfiguredError', () => {
    it('should create error with correct message', () => {
      const error = new VapidNotConfiguredError() as Error & { code: string; statusCode: number };
  ...
  describe('PreferencesNotFoundError', () => {
    it('should create error with user ID', () => {
      const error = new PreferencesNotFoundError('user-123') as Error & {
        code: string;
        statusCode: number;
      };
  ...
  describe('InvalidPreferencesError', () => {
    it('should create error with default message', () => {
      const error = new InvalidPreferencesError() as Error & { code: string; statusCode: number };
      expect(error.message).toBe('Invalid notification preferences');
      expect(error.code).toBe('INVALID_PREFERENCES');
    });

    it('should include details', () => {
      const error = new InvalidPreferencesError('Invalid timezone', {
        field: 'timezone',
      }) as InvalidPreferencesError & { details: unknown };
  ...
  describe('NotificationsDisabledError', () => {
    it('should create error with user ID', () => {
      const error = new NotificationsDisabledError('user-123') as NotificationsDisabledError & {
        message: string;
        code: string;
        statusCode: number;
        userId: string;
    ...
    it('should include notification type', () => {
      const error = new NotificationsDisabledError(
        'user-123',
        'marketing',
      ) as NotificationsDisabledError & { message: string; notificationType: string };
  ...
  describe('QuietHoursActiveError', () => {
    it('should create error with user ID', () => {
      const error = new QuietHoursActiveError('user-123') as QuietHoursActiveError & {
        message: string;
        code: string;
        statusCode: number;
        userId: string;
    ...
    it('should include end time', () => {
      ...
      const error = new QuietHoursActiveError('user-123', endTime) as QuietHoursActiveError & {
        endTime: Date;
        details: { endTime?: string };
      };
