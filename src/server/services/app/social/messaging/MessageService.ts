import {
  ...
  MessageStatus,
  MessageAttachment,
} from "@database/models/messaging/Message";
import { EntityType } from "@database/models/shared/EntityTypes";
import { NotificationType } from "@database/models/social/Notification";
import { ConversationRepository } from "@database/repositories/messaging/ConversationRepository";
import { MessageRepository } from "@database/repositories/messaging/MessageRepository";
import { NotificationService } from "@server/services/app/social/notification/NotificationService";
...
export class MessageService extends BaseService {
  ...
  async getMessage(messageId: string, userId: string): Promise<Message | null> {
    try {
      ...
      // Cache the result
      await this.cacheManager.set(cacheKey, message, MESSAGE_CACHE_TTL);
