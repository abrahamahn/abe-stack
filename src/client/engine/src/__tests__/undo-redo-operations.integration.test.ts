// client/src/__tests__/integration/undo-redo-operations.integration.test.ts
/**
...
describe('UndoRedoStack with Operations Integration', () => {
  ...
  describe('basic undo/redo', () => {
    it('should undo a single field update', () => {
      ...
      // Update name
      write([{ table: 'user', id: 'u1', updates: { name: 'Alice Updated' } as Partial<User> }]);
      ...
      write([
        {
          table: 'user',
          id: 'u1',
          updates: { name: 'Alice New', bio: 'New bio' } as Partial<User>,
        },
      ]);
  ...
  describe('multiple operations', () => {
    it('should undo operations in LIFO order', () => {
      ...
      write([{ table: 'user', id: 'u1', updates: { name: 'Update 1' } as Partial<User> }]);
      write([{ table: 'user', id: 'u1', updates: { name: 'Update 2' } as Partial<User> }]);
      write([{ table: 'user', id: 'u1', updates: { name: 'Update 3' } as Partial<User> }]);
    ...
    it('should clear redo stack on new operation', () => {
      ...
      write([{ table: 'user', id: 'u1', updates: { name: 'New Update' } as Partial<User> }]);
  ...
  describe('multi-record operations', () => {
    it('should undo updates to multiple records atomically', () => {
      ...
      write([
        { table: 'user', id: 'u1', updates: { name: 'Alice Updated' } as Partial<User> },
        { table: 'post', id: 'p1', updates: { title: 'Updated Title' } as Partial<Post> },
      ]);
  ...
  describe('grouped operations', () => {
    it('should undo grouped operations together', () => {
      ...
      write([{ table: 'user', id: 'u1', updates: { name: 'Step 1' } as Partial<User> }]);
      write([{ table: 'user', id: 'u1', updates: { email: 'step2@test.com' } as Partial<User> }]);
      write([{ table: 'user', id: 'u1', updates: { bio: 'Step 3' } as Partial<User> }]);
    ...
    it('should handle withGroup helper', () => {
      ...
      undoStack.withGroup(() => {
        write([{ table: 'user', id: 'u1', updates: { name: 'Grouped 1' } as Partial<User> }]);
        write([
          { table: 'user', id: 'u1', updates: { email: 'grouped@test.com' } as Partial<User> },
        ]);
      });
  ...
  describe('state tracking', () => {
    it('should track canUndo correctly and restore data on undo', () => {
      ...
      write([{ table: 'user', id: 'u1', updates: { name: 'Updated Name' } as Partial<User> }]);
    ...
    it('should notify state changes', () => {
      ...
      write([{ table: 'user', id: 'u1', updates: { name: 'Update' } as Partial<User> }]);
  ...
  describe('skip undo option', () => {
    it('should allow skipping undo stack for certain writes', () => {
      ...
      // Skip undo
      write(
        [{ table: 'user', id: 'u1', updates: { name: 'Skipped Update' } as Partial<User> }],
        true,
      );
    ...
    it('should mix skipUndo and regular writes correctly', () => {
      ...
      write([{ table: 'user', id: 'u1', updates: { name: 'Regular 1' } as Partial<User> }], false);
      write([{ table: 'user', id: 'u1', updates: { name: 'Skipped' } as Partial<User> }], true);
      write([{ table: 'user', id: 'u1', updates: { name: 'Regular 2' } as Partial<User> }], false);
  ...
  describe('edge cases', () => {
    ...
    it('should handle operations on non-existent records gracefully', () => {
      ...
      write([{ table: 'user', id: 'nonexistent', updates: { name: 'Update' } as Partial<User> }]);
