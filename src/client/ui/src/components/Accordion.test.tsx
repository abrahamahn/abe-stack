// src/client/ui/src/components/Accordion.test.tsx
  ...
  describe('edge cases - missing/invalid props', () => {
    ...
    it('handles items with no id gracefully', () => {
      ...
      expect(() => {
        render(
          <Accordion
            items={invalidItems as unknown as Array<{ id: string; title: string; content: string }>}
          />,
        );
      }).not.toThrow();
    });
    ...
    it('handles null onChange gracefully', async () => {
      ...
      render(<Accordion items={items} onChange={null as unknown as (id: string | null) => void} />);
