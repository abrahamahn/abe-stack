...
describe('useSubscription', () => {
  ...
  describe('createCheckout action', () => {
    ...
    it('should handle checkout creation errors', async () => {
      ...
      expect((thrownError as unknown as Error).message).toBe('Payment error');
      expect(result.current.error).toBeInstanceOf(Error);
      expect((result.current.error as unknown as Error).message).toBe('Payment error');
    });
  });
  ...
  describe('cancel action', () => {
    ...
    it('should handle cancellation errors', async () => {
      ...
      expect(thrownError).toBeInstanceOf(Error);
      expect((thrownError as unknown as Error).message).toBe('Cancellation failed');
      expect(result.current.error).toBeInstanceOf(Error);
      expect((result.current.error as unknown as Error).message).toBe('Cancellation failed');
    });
  });
  ...
  describe('resume action', () => {
    ...
    it('should handle resume errors', async () => {
      ...
      expect(thrownError).toBeInstanceOf(Error);
      expect((thrownError as unknown as Error).message).toBe('Resume failed');
      expect(result.current.error).toBeInstanceOf(Error);
      expect((result.current.error as unknown as Error).message).toBe('Resume failed');
    });
  });
  ...
  describe('changePlan action', () => {
    ...
    it('should handle plan change errors', async () => {
      ...
      expect(thrownError).toBeInstanceOf(Error);
      expect((thrownError as unknown as Error).message).toBe('Update failed');
      expect(result.current.error).toBeInstanceOf(Error);
      expect((result.current.error as unknown as Error).message).toBe('Update failed');
    });
  });
...
describe('usePaymentMethods', () => {
  ...
  describe('getSetupIntent action', () => {
    ...
    it('should handle setup intent errors', async () => {
      ...
      expect(thrownError).toBeInstanceOf(Error);
      expect((thrownError as unknown as Error).message).toBe('Setup failed');
      expect(result.current.error).toBeInstanceOf(Error);
      expect((result.current.error as unknown as Error).message).toBe('Setup failed');
    });
  });
  ...
  describe('addPaymentMethod action', () => {
    ...
    it('should handle add payment method errors', async () => {
      ...
      expect(thrownError).toBeInstanceOf(Error);
      expect((thrownError as unknown as Error).message).toBe('Add failed');
      expect(result.current.error).toBeInstanceOf(Error);
      expect((result.current.error as unknown as Error).message).toBe('Add failed');
    });
  });
  ...
  describe('removePaymentMethod action', () => {
    ...
    it('should handle remove payment method errors', async () => {
      ...
      expect(thrownError).toBeInstanceOf(Error);
      expect((thrownError as unknown as Error).message).toBe('Remove failed');
      expect(result.current.error).toBeInstanceOf(Error);
      expect((result.current.error as unknown as Error).message).toBe('Remove failed');
    });
  });
  ...
  describe('setDefault action', () => {
    ...
    it('should handle set default errors', async () => {
      ...
      expect(thrownError).toBeInstanceOf(Error);
      expect((thrownError as unknown as Error).message).toBe('Set default failed');
      expect(result.current.error).toBeInstanceOf(Error);
      expect((result.current.error as unknown as Error).message).toBe('Set default failed');
    });
  });
