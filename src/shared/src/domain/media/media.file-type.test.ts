// src/shared/src/domain/media/media.file-type.test.ts
/**
...
describe('detectFileTypeFromPath', () => {
  ...
  describe('video extensions', () => {
    ...
    test('should detect .mov files', () => {
      expect(detectFileTypeFromPath('movie.mov')).toEqual({
        ext: 'mov',
  ...
  describe('edge cases', () => {
    ...
    test('should handle files with multiple dots', () => {
      expect(detectFileTypeFromPath('archive.tar.gz')).toBeNull();
