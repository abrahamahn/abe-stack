// src/shared/src/domain/media/media.file-type.ts
/**
 * File Type Detection
 *
 * Pure buffer-based file type detection using magic byte signatures.
 * No I/O dependencies — works with any Buffer/Uint8Array source.
 *
 * @module Domain/Media/FileType
 */

import { EXT_TO_MIME } from './media.constants';
