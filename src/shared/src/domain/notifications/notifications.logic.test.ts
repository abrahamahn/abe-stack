// packages/shared/src/domain/notifications/notifications.logic.test.ts
...
describe('notifications.logic', () => {
  ...
  function createPrefs(
    overrides: Partial<NotificationPreferencesConfig> = {},
  ): NotificationPreferencesConfig {
    return {
      userId: 'user-1' as NotificationPreferencesConfig['userId'],
      emailEnabled: true,
      pushEnabled: true,
      categories: {},
      ...overrides,
