// src/tools/scripts/export/server/server-config.ts
/**
 * Server Configuration Exporter
 *
 * Exports all configuration files from src/server/* packages into a single file.
 ...
 *
 * @usage pnpm tsx src/tools/scripts/export/server/server-config.ts
 */
...
const PACKAGE_ALIASES: Record<string, string> = {
  '@abe-stack/server-engine': 'src/server/engine/src',
  '@abe-stack/shared': 'src/shared/src',
  '@abe-stack/ui': 'src/client/ui/src',
  '@abe-stack/react': 'src/client/react/src',
  '@abe-stack/db': 'src/server/db/src',
  '@abe-stack/media': 'src/server/media/src',
  '@abe-stack/websocket': 'src/server/websocket/src',
  '@abe-stack/core': 'src/server/core/src',
  '@abe-stack/api': 'src/client/api/src',
  '@abe-stack/client-engine': 'src/client/engine/src',
  '@abe-stack/realtime': 'src/server/realtime/src',
};
 ...
 * Scans src/server packages for config files and their dependencies,
