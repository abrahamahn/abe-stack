// src/tools/scripts/export/server/server-engine.ts
/**
 * Server Engine Package Code Exporter
 *
 * Exports all source code from src/server/engine into a single file
 * for code review or AI context. Excludes test files and build artifacts.
 *
 * @usage pnpm tsx src/tools/scripts/export/server/server-engine.ts
 */
...
/**
 * Exports all source files from src/server/engine into .tmp/server-engine.txt.
