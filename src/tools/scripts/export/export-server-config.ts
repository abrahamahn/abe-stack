...
const CONFIG_DIRECTORIES = ['apps/server/src/config', 'backend/engine/src/config'];

/** Package alias mappings to source directories */
const PACKAGE_ALIASES: Record<string, string> = {
  '@abe-stack/engine': 'backend/engine/src',
  '@abe-stack/shared': 'shared/src',
  '@abe-stack/ui': 'client/ui/src',
  '@abe-stack/react': 'client/react/src',
  '@abe-stack/db': 'infra/src',
  '@abe-stack/media': 'backend/media/src',
