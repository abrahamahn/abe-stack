// src/tools/scripts/export/client/client-ui.ts
/**
 * Client UI Package Exporter
 *
 * Exports all source code from src/client/ui into a single file
 * for code review or AI context.
 *
 * @usage
 *   pnpm tsx src/tools/scripts/export/client/client-ui.ts                     # Export all (no tests)
 *   pnpm tsx src/tools/scripts/export/client/client-ui.ts --include-tests     # Export all with tests
 *   pnpm tsx src/tools/scripts/export/client/client-ui.ts --path src/client/ui/src/elements/Button.tsx
 *   pnpm tsx src/tools/scripts/export/client/client-ui.ts --path src/client/ui/src/elements --with-tests
 */
 ...
 * Otherwise exports the entire src/client/ui package.
 */
async function main(): Promise<void> {
  ...
  if (options.includePaths.length > 0) {
    ...
    // Default: export only src/client/ui
