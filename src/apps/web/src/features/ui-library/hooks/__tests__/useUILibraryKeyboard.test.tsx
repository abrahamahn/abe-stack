// apps/web/src/features/ui-library/hooks/__tests__/useUILibraryKeyboard.test.tsx
import { fireEvent, renderHook } from '@testing-library/react';
import { beforeEach, describe, expect, it, vi } from 'vitest';

import { KEYBOARD_SHORTCUTS, useUILibraryKeyboard } from '../useUILibraryKeyboard';
...
describe('useUILibraryKeyboard', () => {
  ...
  it('toggles left panel when L key is pressed', () => {
    renderHook(() => {
      useUILibraryKeyboard(defaultOptions);
    });
