// src/apps/web/src/features/ui-library/components/UILibraryPreviewArea.tsx
import { Button, Heading, ScrollArea, Text } from '@abe-stack/ui';

import type { ComponentDemo } from '../types';

interface UILibraryPreviewAreaProps {
  selectedComponent: ComponentDemo | null;
}

export const UILibraryPreviewArea = ({
  selectedComponent,
}: UILibraryPreviewAreaProps): React.ReactElement => {
  return (
