...
describe('FormField', () => {
  ...
  it('shows required indicator when required', () => {
    ...
    expect(screen.getByText('*')).toHaveClass('ui-form-field-required');
  });
  ...
  it('displays error message with role alert', () => {
    ...
    expect(error).toHaveClass('ui-form-field-error');
  });
  ...
  it('displays helper text when no error', () => {
    ...
    expect(screen.getByText("We'll never share your email")).toHaveClass('ui-form-field-helper');
  });
