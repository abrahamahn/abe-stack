// backend/server/src/infra/email/index.ts
/**
 ...
 */
export function createEmailService(isProduction: boolean): EmailService {
  return isProduction ? new SmtpEmailService() : new ConsoleEmailService();
}
