...
describe('Query Keys', () => {
  ...
  describe('QueryKeys structure', () => {
    ...
    test('should handle detail with multiple parameters', () => {
      ...
      const detailKey = (complexKeys.detail as unknown as (id: string, itemId: string) => DetailQueryKey<string>)('order-123', 'item-456');
  ...
  describe('edge cases', () => {
    ...
    test('should handle undefined and null in parameters', () => {
      ...
      const keyWithNull = (keys.detail as unknown as (id: string) => string[])(null as unknown as string);
      const keyWithUndefined = (keys.detail as unknown as (id: string) => string[])(undefined as unknown as string);
