...
import { getRecordsRequestSchema, transactionSchema } from '@abe-stack/shared';
...
import type { GetRecordsRequest, RecordPointer, RealtimeTransaction } from '@abe-stack/shared';
