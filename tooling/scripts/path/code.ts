// tooling/scripts/path/code.ts
/**
 * Exports source code files (.ts, .tsx, etc.) to .tmp/PATH-code.md
 * Excludes: index.ts, types.ts, config files, markdown, tooling, infra
 * @module tooling/scripts/path/code
 */
...
const EXCLUDED_PATHS = new Set([
  'packages/ui/src/styles', // CSS files go to config
]);
