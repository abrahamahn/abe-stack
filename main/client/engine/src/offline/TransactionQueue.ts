// main/client/engine/src/offline/TransactionQueue.ts
/**
...
export type QueuedTransaction = RealtimeTransaction;
 ...
 */
function extractPointers(operations: RealtimeOperation[]): TransactionRecordPointer[] {
