// main/client/react/src/hooks/useLocalStorage.test.ts
/**
...
describe('useLocalStorage', () => {
  ...
  describe('setValue', () => {
    ...
    it('should handle setting undefined by storing null', async () => {
      const { result } = renderHook(() => useLocalStorage<string | undefined>('maybe', 'value'));
  ...
  describe('SSR safety', () => {
    it('should return initial value when localStorage is unavailable', () => {
    ...
    it('should not call localStorage when localStorage is unavailable', () => {
      const originalLocalStorage = window.localStorage;
      const getItemSpy = vi.spyOn(Storage.prototype, 'getItem');
      Object.defineProperty(window, 'localStorage', { value: undefined, configurable: true });
