// main/client/react/src/hooks/useKeyboardShortcuts.test.ts
...
describe('useKeyboardShortcuts', () => {
  ...
  it('respects ctrlKey modifier', () => {
    const handler = vi.fn();
    render(createElement(ShortcutsHarness, { shortcuts: [{ key: 'K', handler, ctrlKey: true }] }));
  ...
  it('respects shiftKey modifier', () => {
    const handler = vi.fn();
    render(createElement(ShortcutsHarness, { shortcuts: [{ key: 'S', handler, shiftKey: true }] }));
