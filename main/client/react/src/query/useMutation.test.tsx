// main/client/react/src/query/useMutation.test.tsx
/**
...
describeSlow('useMutation - Race Conditions', () => {
  ...
  it('should track current mutation ID correctly with manual resolution', async () => {
    ...
    expect((promise1Error as unknown as Error).message).toBe('Mutation superseded');
...
describe('useMutation - Edge Cases', () => {
  ...
  it('should throw error when used without cache provider', () => {
    ...
    try {
      ...
      expect.fail('Expected hook to throw an error');
    } catch (error) {
      // React 18 throws directly during render
