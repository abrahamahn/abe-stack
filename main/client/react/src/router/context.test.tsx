// main/client/react/src/router/context.test.tsx
/**
 * Unit tests for custom router context implementation.
 *
 * Tests cover:
 * - Browser history abstraction (push, replace, scroll restoration)
 ...
 *
 * Note: BrowserRouter tests are limited by jsdom's history API.
 * jsdom's history.go() does not reliably trigger popstate events,
 * so back/forward navigation tests use MemoryRouter instead.
 *
 ...
 */
const RouterHarness = (): ReactElement => {
 ...
 */
const NavigationTypeHarness = (): ReactElement => {
 ...
 */
const HistoryHarness = (): ReactElement => {
 ...
 */
const MemoryRouterHarness = (): ReactElement => {
...
describe('Router (BrowserRouter)', () => {
  ...
  afterEach(() => {
    vi.clearAllMocks();
    // Reset browser history after each test
    window.history.replaceState(null, '', '/');
  });
  ...
  describe('scroll restoration', () => {
    ...
    it('should prevent scroll reset when preventScrollReset is true', async () => {
      ...
      // When preventScrollReset is true, scrollTo(0,0) should NOT be called
      const scrollToTopCalls = scrollToMock.mock.calls.filter(
    ...
    it('should disable scroll restoration when scrollRestoration is false', async () => {
      ...
      // When scrollRestoration is false, scrollTo should not be called
...
describe('MemoryRouter', () => {
  ...
  describe('navigation type tracking', () => {
    it('should track PUSH navigation type', async () => {
      ...
      const NavTypeHarness = (): ReactElement => {
  ...
  describe('setLocation helper', () => {
    it('should expose setLocation for direct location updates', async () => {
      ...
      const SetLocationHarness = (): ReactElement => {
...
describe('useRouterContext', () => {
  ...
  it('should throw error when used outside Router', () => {
    ...
    const InvalidConsumer = (): ReactElement => {
  ...
  it('should provide navigate function', async () => {
    ...
    const NavigateHarness = (): ReactElement => {
...
describe('useNavigationType', () => {
  ...
  it('should update when navigation type changes', async () => {
    ...
    const NavTypeChangeHarness = (): ReactElement => {
      const navType = useNavigationType();
      const { navigate } = useRouterContext();
...
describe('RouterContext', () => {
  it('should be createable with custom value', () => {
    ...
    const CustomConsumer = (): ReactElement => {
      const context = useRouterContext();
      return (
        <div>
...
describe('Router Integration', () => {
  it('should handle complex navigation flows', async () => {
    ...
    const ComplexHarness = (): ReactElement => {
      const { location, navigate } = useRouterContext();
      return (
        <div>
          <div data-testid="pathname">{location.pathname}</div>
