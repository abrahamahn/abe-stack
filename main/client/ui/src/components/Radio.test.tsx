// main/client/ui/src/components/Radio.test.tsx
...
describe('Radio', () => {
  ...
  it('shows visual indicator when checked', () => {
    ...
    expect(container.querySelector('.radio-dot')).toBeInTheDocument();

    rerender(<Radio name="test" label="Visual" checked={false} />);
    expect(container.querySelector('.radio-dot')).not.toBeInTheDocument();
  });
