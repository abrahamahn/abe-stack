...
export const generatedRouteDefinitions = [
  ...
  { method: "POST", path: "/api/admin/billing/plans/:id/deactivate", module: "admin", public: false },
  { method: "POST", path: "/api/admin/billing/plans/:id/sync-stripe", module: "admin", public: false },
  ...
  { method: "POST", path: "/api/admin/feature-flags/:key/delete", module: "feature-flags", public: false },
  { method: "POST", path: "/api/admin/feature-flags/:key/update", module: "feature-flags", public: false },
  { method: "POST", path: "/api/admin/feature-flags/create", module: "feature-flags", public: false },
  ...
  { method: "GET", path: "/api/admin/tenants/:tenantId/feature-overrides", module: "feature-flags", public: false },
  { method: "PUT", path: "/api/admin/tenants/:tenantId/feature-overrides/:key", module: "feature-flags", public: false },
  { method: "POST", path: "/api/admin/tenants/:tenantId/feature-overrides/:key/delete", module: "feature-flags", public: false },
  ...
  { method: "POST", path: "/api/admin/webhooks/:id/deliveries/:deliveryId/replay", module: "admin", public: false },
  ...
  { method: "POST", path: "/api/billing/payment-methods/:id/default", module: "billing", public: false },
  ...
  { method: "POST", path: "/api/notifications/mark-all-read", module: "notifications", public: false },
  ...
  { method: "PUT", path: "/api/notifications/preferences/update", module: "notifications", public: false },
  ...
  { method: "POST", path: "/api/notifications/unsubscribe", module: "notifications", public: false },
  ...
  { method: "POST", path: "/api/tenants/:id/invitations/:invitationId/regenerate", module: "tenants", public: false },
  { method: "POST", path: "/api/tenants/:id/invitations/:invitationId/resend", module: "tenants", public: false },
  { method: "POST", path: "/api/tenants/:id/invitations/:invitationId/revoke", module: "tenants", public: false },
  ...
  { method: "POST", path: "/api/tenants/:id/members/:userId/remove", module: "tenants", public: false },
  { method: "POST", path: "/api/tenants/:id/members/:userId/role", module: "tenants", public: false },
  ...
  { method: "POST", path: "/api/webhooks/deliveries/:deliveryId/replay", module: "webhooks", public: false },
