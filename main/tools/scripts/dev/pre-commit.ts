// main/tools/scripts/dev/pre-commit.ts
/**
...
function main(): void {
  ...
  if (eslintFiles.length > 0) {
    ...
    run(
      `pnpm eslint --cache --cache-location node_modules/.cache/eslint/.cache --report-unused-disable-directives --max-warnings=0 --no-warn-ignored ${files}`,
    );
  }
