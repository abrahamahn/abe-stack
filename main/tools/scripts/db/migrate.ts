// main/tools/scripts/db/migrate.ts
/**
 * Database Migration Runner
 *
 * Applies SQL migration files from main/server/db/migrations/ in order.
 * Tracks applied migrations in a `migrations` table to ensure idempotency.
 *
 * @usage pnpm db:migrate
 * @usage pnpm tsx main/tools/scripts/db/migrate.ts
 */
...
/** Resolve repo root from main/tools/scripts/db/ (4 levels up) */
