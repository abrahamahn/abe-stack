// main/apps/storybook/src/stories/layouts/Modal.stories.tsx
    ...
    <ModalDemo label="Quick Note">
      {({ onClose }) => (
        <>
          ...
          <Modal.Body>
            <Text>A simple notification or quick message in a minimal modal.</Text>
          </Modal.Body>
          <Modal.Footer>
            <Button variant="primary" onClick={onClose}>
              OK
