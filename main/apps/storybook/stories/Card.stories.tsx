    ...
    <Card>
      ...
      <Card.Body>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--ui-gap-sm)' }}>
          <Text>A collaborative workspace for your team to manage tasks, share files, and track progress.</Text>
          <div style={{ display: 'flex', gap: 'var(--ui-gap-md)', marginTop: 'var(--ui-gap-sm)' }}>
            <div>
              <Text tone="muted" style={{ fontSize: 'var(--ui-font-size-sm)' }}>Members</Text>
              <Text style={{ fontWeight: 'var(--ui-font-weight-semibold)' }}>12</Text>
            </div>
            <div>
              <Text tone="muted" style={{ fontSize: 'var(--ui-font-size-sm)' }}>Tasks</Text>
              <Text style={{ fontWeight: 'var(--ui-font-weight-semibold)' }}>48</Text>
            </div>
            <div>
              <Text tone="muted" style={{ fontSize: 'var(--ui-font-size-sm)' }}>Completed</Text>
