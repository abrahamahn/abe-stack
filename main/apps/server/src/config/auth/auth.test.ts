// main/apps/server/src/config/auth/auth.test.ts
...
// TODO: Re-enable when getRefreshCookieOptions is implemented
...
// TODO: Re-enable when isStrategyEnabled is implemented
