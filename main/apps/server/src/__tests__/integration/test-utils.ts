// main/apps/server/src/__tests__/integration/test-utils.ts
/**
...
import { registerCookies } from '../../http/middleware/cookie';
import { registerCorrelationIdHook } from '../../http/middleware/correlationId';
...
export function buildAuthenticatedRequest(options: AuthenticatedRequestOptions): InjectOptions {
  ...
  // Add workspace ID header for tenant-scoped tests
  if (workspaceId !== undefined) {
    allHeaders['x-workspace-id'] = workspaceId;
  }
