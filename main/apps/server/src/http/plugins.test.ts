// main/apps/server/src/http/plugins.test.ts
/**
...
vi.mock('./middleware', () => ({
  ...
  registerCsrf: vi.fn(),
  registerMultipartFormParser: vi.fn(),
...
describe('registerPlugins', () => {
  ...
  describe('middleware registration order', () => {
    ...
    it('should register multipart form parser', () => {
      registerPlugins(mockFastify, mockOptions);

      expect(middleware.registerMultipartFormParser).toHaveBeenCalledWith(mockFastify);
    });
  ...
  describe('request logging ownership', () => {
    it('should not register request timing/response logging hooks (handled by logger module)', () => {
      registerPlugins(mockFastify, mockOptions);
