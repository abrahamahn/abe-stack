// main/apps/web/src/features/workspace/hooks/useWorkspaceBilling.test.ts
/**
...
describe('useWorkspaceBilling', () => {
  ...
  it('should fetch subscription data', async () => {
    ...
    mockGetSubscription.mockResolvedValue(mockResponse);
  ...
  it('should handle fetch errors', async () => {
    mockGetSubscription.mockRejectedValue(new Error('Failed to fetch subscription'));
