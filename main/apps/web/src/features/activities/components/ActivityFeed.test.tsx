// main/apps/web/src/features/activities/components/ActivityFeed.test.tsx
/**
...
describe('ActivityFeed', () => {
  ...
  describe('activity items', () => {
    ...
    it('should not crash when resourceId is undefined', () => {
      const baseActivity = mockActivities[0];
      if (baseActivity === undefined) throw new Error('Expected mock activity fixture');

      const activityWithUndefinedResourceId: ActivityLocal = {
        ...baseActivity,
        resourceId: undefined as unknown as string,
      };

      vi.mocked(useActivities).mockReturnValue({
        activities: [activityWithUndefinedResourceId],
        isLoading: false,
        isError: false,
        error: null,
        refetch: vi.fn(),
