// main/apps/web/src/features/activities/components/ActivityFeed.tsx
/**
 * ActivityFeed
 *
...
function ActivityItem({ activity }: { activity: ActivityLocal }): ReactElement {
  ...
  const resourceType = typeof activity.resourceType === 'string' ? activity.resourceType : '';
  const resourceId = typeof activity.resourceId === 'string' ? activity.resourceId : '';
  const description = typeof activity.description === 'string' ? activity.description : null;
