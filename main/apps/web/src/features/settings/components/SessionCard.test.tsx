// main/apps/web/src/features/settings/components/SessionCard.test.tsx
/**
...
describe('SessionCard', () => {
  ...
  describe('revoke functionality', () => {
    ...
    it('should disable revoke button when revoking', () => {
      ...
      const revokeButton = screen.getByRole('button', { name: 'Revoking...' });
  ...
  describe('edge cases', () => {
    ...
    it('should render revoke button with correct styling', () => {
      ...
      const revokeButton = screen.getByRole('button', { name: 'Revoke' });
      expect(revokeButton).toHaveClass('btn-text');
      expect(revokeButton).toHaveClass('btn-small');
    });
    ...
    it('should render badge with correct tone for current session', () => {
      ...
      const badge = screen.getByText('Current Session');
