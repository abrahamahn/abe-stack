// main/apps/web/src/features/settings/components/AvatarUpload.test.tsx
/**
...
vi.mock('@abe-stack/ui', async () => {
  ...
  const mockAvatar = ({ src, alt, className }: { src: string; alt: string; className: string }) => (
...
describe('AvatarUpload', () => {
  ...
  describe('file selection', () => {
    ...
    it('should validate file type - reject invalid types', () => {
      render(<AvatarUpload {...defaultProps} />);
  ...
  describe('edge cases', () => {
    ...
    it('should not call uploadAvatar when no file selected', () => {
      render(<AvatarUpload {...defaultProps} />);
