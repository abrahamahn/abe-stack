// main/apps/web/src/features/settings/hooks/useConsent.test.ts
...
describe('useUpdateConsent', () => {
  ...
  it('should update consent preferences', async () => {
    ...
    expect(mockFetch).toHaveBeenCalledWith(
      'http://localhost:3000/api/users/me/consent/update',
  ...
  it('should handle network error', async () => {
    ...
    ).rejects.toThrow('Failed to fetch PATCH /users/me/consent/update');
