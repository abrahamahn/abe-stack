// main/shared/src/utils/monitor/health.ts
/**
...
/**
 * Minimal interface for a cache system health check.
 */
...
/**
 * Minimal interface for a queue system health check.
 */
 ...
 *
 * @param cache - A cache instance with stats
 * @returns Service health with cache stats
 * @complexity O(1)
 */
 ...
 *
 * @param queue - A queue instance with stats
 * @returns Service health with queue stats
 * @complexity O(1)
 */
