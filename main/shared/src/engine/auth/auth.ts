// main/shared/src/engine/auth/auth.ts
/**
 * Authentication & Authorization Domain
 *
 * Helper functions for auth configuration and specific error types
 * for auth flows including login, tokens, OAuth, and 2FA.
 */
...
// (All types are imported from config/types/auth and re-exported via index.ts)
