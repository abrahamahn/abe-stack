...
export { emptyBodySchema, errorResponseSchema, type EmptyBody } from '../../core/schemas';
...
export const deviceListResponseSchema: Schema<DeviceListResponse> = createSchema((data: unknown) => {
  const obj = (data !== null && typeof data === 'object' ? data : {}) as Record<string, unknown>;
...
export const trustDeviceResponseSchema: Schema<TrustDeviceResponse> = createSchema((data: unknown) => {
  const obj = (data !== null && typeof data === 'object' ? data : {}) as Record<string, unknown>;
  return {
...
export const passkeyListResponseSchema: Schema<PasskeyListItem[]> = createSchema((data: unknown) => {
...
export const webauthnOptionsResponseSchema: Schema<WebauthnOptionsResponse> = createSchema(
  (data: unknown) => {
    const obj = (data !== null && typeof data === 'object' ? data : {}) as Record<string, unknown>;
    if (obj['options'] === null || obj['options'] === undefined || typeof obj['options'] !== 'object') {
