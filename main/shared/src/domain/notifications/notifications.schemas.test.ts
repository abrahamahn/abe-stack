...
describe('notificationsListResponseSchema', () => {
  it('should parse valid in-app list response', () => {
...
describe('notificationDeleteRequestSchema', () => {
  it('should parse valid delete request', () => {
    const result = notificationDeleteRequestSchema.parse({ id: 'notif-1' });
    expect(result.id).toBe('notif-1');
  });
});

// ============================================================================
// markReadResponseSchema / deleteNotificationResponseSchema
// ============================================================================

describe('notification mutation response schemas', () => {
  it('should parse mark read response', () => {
    const result = markReadResponseSchema.parse({ message: 'ok', count: 2 });
    expect(result.count).toBe(2);
  });

  it('should parse delete response', () => {
    const result = deleteNotificationResponseSchema.parse({ message: 'deleted' });
