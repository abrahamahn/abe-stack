...
import { AppError, BadRequestError, ConflictError, NotFoundError } from '../../core/errors';
...
export class PlanNotFoundError extends NotFoundError {
  constructor(planId?: string) {
    super(
      planId !== undefined && planId !== '' ? `Plan not found: ${planId}` : 'Plan not found',
      'PLAN_NOT_FOUND',
    );
  }
}
  ...
  constructor(userId?: string) {
    super(
      userId !== undefined && userId !== ''
        ? `Billing customer not found for user: ${userId}`
