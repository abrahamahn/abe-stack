// main/shared/src/core/users/schemas.test.ts

/**
 * @file Unit Tests for Schemas
 * @description Tests for shared schema primitives (datetime, email, password, error, success).
