// main/shared/src/core/auth/password/auth.password-scoring.test.ts
/**
 * @file Password Scoring Tests
 * @description Tests for entropy, crack time, score, and feedback generation.
...
import type { PasswordPenalties } from './auth.password-scoring';
