// main/shared/src/core/auth/password/auth.password-patterns.ts
/**
 * @file Password Pattern Detection
 * @description Functions to detect weak patterns in passwords (repeats, sequences,
 *   keyboard patterns, common passwords, user input).
 * @module Core/Auth
 */

import { COMMON_PASSWORDS, KEYBOARD_PATTERNS } from '../../constants/auth';

export { COMMON_PASSWORDS, KEYBOARD_PATTERNS };
