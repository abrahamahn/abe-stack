// main/shared/src/core/auth/auth.http-mapper.schemas.test.ts
/**
 * @file Auth HTTP Error Mapper Tests
 * @description Tests for error-to-HTTP-response mapping.
...
} from './auth.http-mapper.schemas';

import type { ErrorMapperLogger } from './auth.http-mapper.schemas';

/**
 * Creates a mock logger for testing
 */
function createMockLogger(): ErrorMapperLogger {
  return {
    warn: vi.fn(),
    error: vi.fn(),
  };
