// main/shared/src/primitives/config/types/services.test.ts
/**
...
describe('BillingConfig', () => {
  ...
  it('should enforce provider type constraint', () => {
    expectTypeOf<BillingConfig>().toHaveProperty('provider').toEqualTypeOf<'stripe' | 'paypal'>();
  });
...
describe('SqlTableConfig', () => {
  ...
  it('should enforce primaryKey as string or string array', () => {
    expectTypeOf<SqlTableConfig>().toHaveProperty('primaryKey').toEqualTypeOf<string | string[]>();
  });
});
