...
-- Memberships: Users can see memberships for tenants they belong to
...
-- API Keys: Scoped to tenant OR user (some keys might be personal)
...
-- 3. Bypass RLS for service roles (Usually handled by being table owner)
-- We explicitly grant bypass for a hypothetical "migration_manager" or similar if needed.
