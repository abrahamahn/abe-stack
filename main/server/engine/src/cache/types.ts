// main/server/engine/src/cache/types.ts
/**
 * Cache Package Types
 *
 * Re-exports shared cache types and defines engine-specific types
 * for provider configuration, eviction, memoization, and logging.
 */
