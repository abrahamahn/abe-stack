...
const apiKeyRouteEntries: [string, RouteDefinition][] = [
  ...
  [
    ...
    protectedRoute('POST', handleCreateApiKey, 'user', createApiKeyRequestSchema, {
  ...
  [
    ...
    protectedRoute('POST', handleRevokeApiKey, 'user', emptyBodySchema, {
  ...
  [
    ...
    protectedRoute('DELETE', handleDeleteApiKey, 'user', emptyBodySchema, {
