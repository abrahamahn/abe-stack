// main/server/core/src/auth/routes.test.ts
/**
...
describe('Auth Routes', () => {
  ...
  describe('auth/refresh Route', () => {
    ...
    test('should not require a request body schema', () => {
      expect(refreshRoute.schema).toBe(emptyBodySchema);
    });
  ...
  describe('auth/logout Route', () => {
    ...
    test('should not require a request body schema', () => {
      expect(logoutRoute.schema).toBe(emptyBodySchema);
    });
  ...
  describe('auth/logout-all Route', () => {
    ...
    test('should not require a request body schema', () => {
      expect(logoutAllRoute.schema).toBe(emptyBodySchema);
    });
