// main/server/core/src/auth/security/events.test.ts
...
// Mock email templates (temporarily inline due to package export issues)
const emailTemplates = {
  ...
  securityNotification: vi.fn().mockImplementation((type: string, details: string) => ({
