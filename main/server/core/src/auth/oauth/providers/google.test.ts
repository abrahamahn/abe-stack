// main/server/core/src/auth/oauth/providers/google.test.ts
/**
...
describe('exchangeCode', () => {
  ...
  describe('successful token exchange', () => {
    ...
    it('should handle response without refresh token', async () => {
      const { refresh_token: _refreshToken, ...mockTokenResponse } = createMockTokenResponse();
    ...
    it('should handle response without id_token', async () => {
      const { id_token: _idToken, ...mockTokenResponse } = createMockTokenResponse();
...
describe('getUserInfo', () => {
  ...
  describe('successful user info retrieval', () => {
    ...
    it('should handle missing optional picture field', async () => {
      const { picture: _picture, ...mockUserInfo } = createMockUserInfo();
