// main/server/core/src/notifications/routes.test.ts
/**
...
describe('Notification Routes', () => {
  describe('Route Map Structure', () => {
    test('should export notificationRoutes as a RouteMap', () => {
      ...
      expect(notificationRoutes).toBeInstanceOf(Map);
    });
  ...
  describe('notifications/vapid-key Route', () => {
    const vapidKeyRoute = notificationRoutes.get('notifications/vapid-key')!;
    ...
    test('should be a public route (no auth required)', () => {
      expect(vapidKeyRoute.isPublic).toBe(true);
    });
  ...
  describe('notifications/subscribe Route', () => {
    const subscribeRoute = notificationRoutes.get('notifications/subscribe')!;
    ...
    test('should require user authentication', () => {
      expect(subscribeRoute.isPublic).toBe(false);
    });
  ...
  describe('notifications/unsubscribe Route', () => {
    const unsubscribeRoute = notificationRoutes.get('notifications/unsubscribe')!;
    ...
    test('should require user authentication', () => {
      expect(unsubscribeRoute.isPublic).toBe(false);
    });
  ...
  describe('notifications/preferences Route', () => {
    const preferencesRoute = notificationRoutes.get('notifications/preferences')!;
    ...
    test('should require user authentication', () => {
      expect(preferencesRoute.isPublic).toBe(false);
    });
  ...
  describe('notifications/preferences/update Route', () => {
    const updatePreferencesRoute = notificationRoutes.get('notifications/preferences/update')!;
    ...
    test('should require user authentication', () => {
      expect(updatePreferencesRoute.isPublic).toBe(false);
    });
  ...
  describe('notifications/test Route', () => {
    const testRoute = notificationRoutes.get('notifications/test')!;
    ...
    test('should require user authentication', () => {
      expect(testRoute.isPublic).toBe(false);
    });

    test('should not require a request body schema', () => {
      expect(testRoute.schema).toBe(emptyBodySchema);
    });
  ...
  describe('notifications/send Route', () => {
    const sendRoute = notificationRoutes.get('notifications/send')!;
    ...
    test('should require admin authentication', () => {
      expect(sendRoute.isPublic).toBe(false);
      expect(sendRoute.roles).toContain('admin');
    });
...
describe('Route Protection', () => {
  ...
  test('should have exactly 1 admin-protected route', () => {
    const adminRoutes = Array.from(notificationRoutes.entries()).filter(
      ([_, def]: [string, RouteDefinition]) =>
        !def.isPublic && def.roles?.includes('admin') === true,
    );
  ...
  test('should have correct auth levels for all routes', () => {
    expect(notificationRoutes.get('notifications/vapid-key')!.isPublic).toBe(true);
    expect(notificationRoutes.get('notifications/subscribe')!.isPublic).toBe(false);
    expect(notificationRoutes.get('notifications/unsubscribe')!.isPublic).toBe(false);
    expect(notificationRoutes.get('notifications/preferences')!.isPublic).toBe(false);
    expect(notificationRoutes.get('notifications/preferences/update')!.isPublic).toBe(false);
...
describe('Route Methods', () => {
  ...
  test('should use POST method for creation and action routes', () => {
    expect(notificationRoutes.get('notifications/subscribe')!.method).toBe('POST');
    expect(notificationRoutes.get('notifications/unsubscribe')!.method).toBe('POST');
    expect(notificationRoutes.get('notifications/test')!.method).toBe('POST');
    expect(notificationRoutes.get('notifications/send')!.method).toBe('POST');
  });

  test('should use PUT method for update routes', () => {
    expect(notificationRoutes.get('notifications/preferences/update')!.method).toBe('PUT');
  });

  test('should not use PATCH or DELETE methods', () => {
    const routes = Array.from(notificationRoutes.values());
