// main/server/realtime/src/routes.test.ts
/**
...
describe('Realtime Routes', () => {
  describe('Route Map Structure', () => {
    test('should export realtimeRoutes as a RouteMap', () => {
      ...
      expect(realtimeRoutes instanceof Map).toBe(true);
    });

    test('should define realtime/write route', () => {
      expect(realtimeRoutes.get('realtime/write')).toBeDefined();
    });

    test('should define realtime/getRecords route', () => {
      expect(realtimeRoutes.get('realtime/getRecords')).toBeDefined();
    });

    test('should only define expected routes', () => {
      const routeKeys = Array.from(realtimeRoutes.keys());
  ...
  describe('realtime/write Route', () => {
    const writeRoute = realtimeRoutes.get('realtime/write');
  ...
  describe('realtime/getRecords Route', () => {
    const getRecordsRoute = realtimeRoutes.get('realtime/getRecords');
