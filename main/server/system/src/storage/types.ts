// main/server/system/src/storage/types.ts
/**
...
export type { LocalStorageConfig, S3StorageConfig, StorageConfig } from '@bslt/shared/system';
 ...
 */
export type { StorageClient as StorageProvider } from '@bslt/shared/system';
