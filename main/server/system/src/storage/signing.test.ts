// main/server/system/src/storage/signing.test.ts
...
describe('signedUrls', () => {
  ...
  describe('createSignedUrl', () => {
    ...
    it('should normalize the filename', () => {
      ...
      expect(url).toContain('My_File_1_.pdf');
    });
  ...
  describe('normalizeFilename', () => {
    ...
    it('should handle unicode characters', () => {
      ...
      expect(normalizeFilename('文件.txt')).toBe('_.txt');
    });
  ...
  describe('integration', () => {
    ...
    it('should create and parse URL roundtrip', () => {
      ...
      // Filename is normalized: consecutive special chars collapsed, extension lowercased
      expect(parsed?.filename).toBe('My_Document_1_.pdf');
