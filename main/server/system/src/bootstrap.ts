// main/server/system/src/bootstrap.ts
/**
 * System Bootstrap
 *
 * Assembles the full SystemContext from infrastructure services.
 * Canonical location: @bslt/server-system
 * Re-exported from @bslt/core for backwards compatibility.
 */
