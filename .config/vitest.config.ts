        ...
        resolve: {
          alias: [
            ...
            // @abe-stack/core subpaths (must come before main alias)
            {
              ...
              replacement: path.join(repoRoot, 'packages/core/src/infrastructure/http'),
            },
            {
              find: '@abe-stack/core/crypto',
              replacement: path.join(repoRoot, 'packages/core/src/infrastructure/crypto'),
            },
            {
              find: '@abe-stack/core/errors',
              replacement: path.join(repoRoot, 'packages/core/src/errors'),
            },
            {
              find: '@abe-stack/core/contracts',
              replacement: path.join(repoRoot, 'packages/core/src/contracts'),
            },
            {
              find: '@abe-stack/core/utils',
              replacement: path.join(repoRoot, 'packages/core/src/utils'),
            },
            {
            ...
            },
            {
              ...
              replacement: path.join(repoRoot, 'packages/core/src/shared'),
            },
            {
              find: '@abe-stack/core/infrastructure',
              replacement: path.join(repoRoot, 'packages/core/src/infrastructure'),
            },
            {
              find: '@abe-stack/core/domains/auth',
              replacement: path.join(repoRoot, 'packages/core/src/domains/auth'),
            },
            {
              find: '@abe-stack/core/domains/users',
              replacement: path.join(repoRoot, 'packages/core/src/domains/users'),
            },
            {
              find: '@abe-stack/core/domains/pagination',
              replacement: path.join(repoRoot, 'packages/core/src/domains/pagination'),
            },
            {
              find: '@abe-stack/core/domains/admin',
              replacement: path.join(repoRoot, 'packages/core/src/domains/admin'),
            },
            {
              find: '@abe-stack/media',
              replacement: path.join(repoRoot, 'packages/media/src'),
            },
