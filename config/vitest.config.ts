...
/**
 * Shared Vitest configurations for individual packages.
 * These can be imported by package-level vitest configs.
 */
...
export const webConfig: UserConfig = defineConfig({
  plugins: [react()],
  test: {
    environment: 'jsdom',
    globals: true,
...
export const serverConfig: UserConfig = defineConfig({
  test: {
    environment: 'node',
    globals: true,
